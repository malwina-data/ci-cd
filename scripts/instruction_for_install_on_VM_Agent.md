...
Once connected to the EC2 instance, follow these steps:
...
Run a test pipeline in Azure DevOps that uses the configured service connection to deploy or interact with the EC2 instance.

## Notes

- Ensure your EC2 instance's security group allows inbound SSH traffic on port 22.
- If you encounter issues during configuration, consult Azure DevOps and Terraform documentation for troubleshooting.

With this setup, you can deploy and manage your infrastructure and Azure DevOps agents efficiently.
